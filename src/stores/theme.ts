...
export const useThemeConfig = defineStore('themeConfig', () => {
    ...
    // 主题设置配置
    const themeConfig = ref<ThemeConfigState>({
        ...
        isRequestRoutes: !!JSON.parse(import.meta.env.VITE_REQUEST_ROUTE as string),
    ...
    /**
     * 更新theme布局配置
     * @param data {ThemeConfigState} 布局配置
     */
    const setThemeConfig = (data: ThemeConfigState) => {
     ...
     * @param data {ThemeConfigState} 布局配置
     */
    const saveThemeConfig = (data?: ThemeConfigState) => {
        Local.set('themeConfig', data || themeConfig.value)
    }
